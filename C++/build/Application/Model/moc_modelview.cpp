/****************************************************************************
** Meta object code from reading C++ file 'modelview.hpp'
**
...
#include "../../../Application/Model/modelview.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'modelview.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ModelView_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ModelView_t qt_meta_stringdata_ModelView = {
    {
QT_MOC_LITERAL(0, 0, 9), // "ModelView"
QT_MOC_LITERAL(1, 10, 13), // "repaint_scene"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 12) // "notifyServer"

    },
    "ModelView\0repaint_scene\0\0notifyServer"
};
...
void ModelView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->repaint_scene(); break;
        case 1: _t->notifyServer(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ModelView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ModelView.data,
...
void *ModelView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ModelView.stringdata))
